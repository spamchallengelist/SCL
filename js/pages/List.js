            ...
            <div class="list-container">
                <table class="list" v-if="list">
                    <tr v-for="([level, err], i) in list">
                        <td class="rank">
                            <p v-if="i + 1 <= 74" class="type-label-lg">#{{ i + 1 }}</p>
                ...
                <div class="level" v-if="level">
                    ...
                    <ul class="stats">
                        <li>
                            ...
                            <p>{{ score(selected + 1, 74, level.percentToQualify) }}</p>
                        </li>
                        <li>
                    ...
                    <h2>Records</h2>
                    <p v-if="selected + 1 <= 74"><strong>{{ level.percentToQualify }}%</strong> or better to qualify</p>
                    <p v-else-if="selected +1 <= 74"><strong>100%</strong> or better to qualify</p>
